...
import com.example.blogserver.entity.CommentsStatistics;
import com.example.blogserver.entity.ThumbsUpStatistics;
import com.example.blogserver.entity.ViewStatistics;
...
public class ReportServiceImpl implements ReportService {
    @Resource
    private ViewStatisticsMapper viewsStatisticsMapper;
    @Resource
    ...
    public Map<String, Object> getReport(Long uid) throws Exception {
        ...
        QueryWrapper<ViewStatistics> wrapper1 = new QueryWrapper<>();
        wrapper1.select("ifnull(sum(one_day),0) as oneDay", "ifnull(sum(two_day),0) as twoDay", "ifnull(sum(three_day),0) as threeDay",
                ...
                .eq("uid", uid);
        ViewStatistics viewsStatistics = viewsStatisticsMapper.selectOne(wrapper1);
